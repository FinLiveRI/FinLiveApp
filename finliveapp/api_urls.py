...
urlpatterns = ([
    ...
    path(r'v1/animal/animal', animal_view.Animals.as_view(), name='animal'),
    re_path(r'v1/animal/breed$', animal_view.BreedsView.as_view(), name='breed'),
    re_path(r'v1/animal/gender$', animal_view.GenderView.as_view(), name='gender'),
